classdef(Abstract) PartitionerGraphWrapperInterface < handle
    ...
    properties(Access=protected)
        ...
        %A graph representing the sparse matrix
        Graph
    ...
    methods(Access=public)
        ...
        function obj = PartitionerGraphWrapperInterface(aGraph)
            %PARTITIONERGRAPHWRAPPERINTERFACE(G) Constructs a graph wrapper to be used for
            %the analysis phase.
