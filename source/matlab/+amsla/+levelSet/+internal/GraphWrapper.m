classdef GraphWrapper < amsla.common.GraphWrapper
    %AMSLA.LEVELSET.INTERNAL.GRAPHWRAPPER Wrapper to a graph to be used for
    %the analysis phase with the level-set approach.
    %
    %   G = AMSLA.LEVELSET.INTERNAL.GRAPHWRAPPER(I, J, V) Create a wrapper
    %   to a graph describer by the triplet I (row indexes), J
    %   (column indexes), and V (edge values).
    %
