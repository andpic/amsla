/// @file bad_kernel.cl
/// Example OpenCL kernels with syntax error. Used for negative testing.
///
...
void kernel bad_add(global const int* A, global const int* B, global int* C) {
  C[get_global_id(] = A[get_global_id(0)] + B[get_global_id(0)];
}
