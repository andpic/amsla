classdef tAnalyser < amsla.test.shared.AnalyserTests
    %TANALYSER Tests for the class amsla.tassl.Analyser
    ...
    methods(Access=protected)
        ...
        function analyserObject = createAnalyserObject(~, I, J, V, maxSubGraphSize)
            analyserObject = amsla.tassl.Analyser(I, J, V, maxSubGraphSize);
        end
