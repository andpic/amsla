classdef tSchedulerGraphWrapper < amsla.test.tools.AmslaTest
    ...
    properties(TestParameter)
        ...
        SetOfParentNodesAndChildrenPair = struct( ...
            'Node1', struct( ...
            'ParentNodes',      { 1 }, ...
    ...
    methods(Test)
        ...
        function identifiesChildrenOfOnlyNodesInSetInSimpleGraph(testCase, ...
                GraphWithEdgesAssigned, ...
                SetOfParentNodesAndChildrenPair)
            % Check that the method 'getChildrenOfOnlyNodesInSet' identifies
            % correctly the children of only the nodes in a given set.
            
            testCase.verifyChildrenMatchExpected( ...
                GraphWithEdgesAssigned, ...
                SetOfParentNodesAndChildrenPair, ...
                @getChildrenOfOnlyNodesInSet);
        end
...
function actualChildren = iObtainChildren(currGraph, method, parentNodes)
wrapperToTest = amsla.common.internal.SchedulerGraphWrapper(currGraph);
