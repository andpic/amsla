...
[I, J, V] = iExampleGraph();
aGraph = iCreateGraphWrapper(I, J, V);
end
...
function wrapper = iCreateGraphWrapper(I, J, V)
persistent underlyingGraph;
underlyingGraph = amsla.common.DataStructure(I, J, V);
wrapper = amsla.levelSet.internal.PartitionerGraphWrapper(underlyingGraph);
end