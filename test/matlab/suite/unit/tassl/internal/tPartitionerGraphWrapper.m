classdef tPartitionerGraphWrapper < amsla.test.tools.AmslaTest
    ...
    methods (Test)
        ...
        function checkSetSortingCriterion(testCase, SortingCriterion)
            ...
            % error
            aGraph = testCase.getASimpleMatrix();
    ...
    methods(Access=private)
        ...
        function [aGraph, I, J, V] = getASimpleMatrix(testCase)
            ...
            testCase.UnderlyingGraph = amsla.common.DataStructure(I, J, V);
            aGraph = amsla.tassl.internal.PartitionerGraphWrapper(testCase.UnderlyingGraph, 3);
        end
